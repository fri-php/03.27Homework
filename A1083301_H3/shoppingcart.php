...
{
	echo '<tr><td><input type="submit" name="two" value="刪除" style="background-color:#ccffff"></td><td style="background-color:#ccffff">s002</td><td style="background-color:#ccffff">'.$_SESSION["B"].'</td><td style="background-color:#ccffff">$'.$_SESSION["b"].'</td><td style="background-color:#ccffff">'.$_COOKIE["quantity2"].'</td></tr>';
}

if(isset($_COOKIE["quantity3"]))
{
	echo '<tr><td><input type="submit" name="three" value="刪除" style="background-color:#ffe6cc"></td><td style="background-color:#ffe6cc">s003</td><td style="background-color:#ffe6cc">'.$_SESSION["C"].'</td><td style="background-color:#ffe6cc">$'.$_SESSION["c"].'</td><td style="background-color:#ffe6cc">'.$_COOKIE["quantity3"].'</td></tr>';
}
